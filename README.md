...
This generates a mock log dataset containing over 50,000+ realistic system logs.
```bash
python log_generator.py

```
### 3. Run the analytical engine:
This parses the dataset line-by-line and generates your structured summary report.
```bash
